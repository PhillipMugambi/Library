...
public class LibraryReturnbook extends javax.swing.JFrame {
...
//            NID.setText(Model.getValueAt(i, 3).toString());
    ...
    public void returned_books() {
        ...
        String book_id = BookId.getText();
        try {
            String sql = "UPDATE  returned_books SET  book_status='Available' WHERE book_id='" + book_id + "' ";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.execute();
    ...
    private void Load_books() {
        ...
        try {
            ...
            String sql = "SELECT `book_name`, `adm_No`, `book_id`FROM returned_books WHERE book_status='borrowed'";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
    ...
    public void search_students() {
        try {
            ...
            String sql = "SELECT book_id,book_name,adm_No FROM returned_books WHERE book_id='" + book_ID + "' AND book_status='borrowed' GROUP by book_id ";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.executeQuery();
            DefaultTableModel tm = (DefaultTableModel) BOOKs.getModel();
            ResultSet rs = preparedStatement.getResultSet();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LibraryReturnbook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LibraryReturnbook().setVisible(true);
            }
        });
    }
