...
public class LibraryReturnedbooks extends javax.swing.JFrame {

    DBconnection db = new DBconnection();

    public LibraryReturnedbooks() {
        initComponents();
        Load_books();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LibraryReturnedbooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LibraryReturnedbooks().setVisible(true);
            }
        });
    }
