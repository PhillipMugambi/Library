...
public class LibraryBorrowedbooks extends javax.swing.JFrame {
    ...
    private void Load_books() {
        ...
        try {
            ...
            java.sql.Connection connection = db.Connect();
            String sql = "SELECT `book_name`, `adm_No`, `book_id`, `issue_date`, `return_date` FROM returned_books WHERE book_status='borrowed'";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            preparedStatement.executeQuery();
            DefaultTableModel tm = (DefaultTableModel) jTable1.getModel();
            ResultSet rs = preparedStatement.getResultSet();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LibraryBorrowedbooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LibraryBorrowedbooks().setVisible(true);
            }
        });
    }
